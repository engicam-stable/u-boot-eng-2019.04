...
static iomux_v3_cfg_t const edimm_ver_pads[] = {
...
static void fec_phy_reset(void)
{
  ...
  //#define ENET_PHY_RST IMX_GPIO_NR(7, 12)
	gpio_request(IMX_GPIO_NR(7, 12), "ENET PHY Reset");
...
char buff[5];  
  ...
  env_set("mmcdev", buff);
	...
	env_set("board_name", "EDIMM STARTER KIT");
